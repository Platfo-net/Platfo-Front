...
ContactDetailsPage.getLayout = (page)=>{
    const updatePostmanMenu = [
        ..._constants_dashboardMenu__WEBPACK_IMPORTED_MODULE_3__/* .postmanMenu */ .fF,
        {
            key: "contact-info",
            path: _constants_enums__WEBPACK_IMPORTED_MODULE_4__/* .Path.PostmanContacts */ .y$.PostmanContacts + "/[id]"
        }
    ];
...
var __webpack_exports__ = __webpack_require__.X(0, [121,676,61,339,745,426,719,228,256,420,23,544], () => (__webpack_exec__(9878)));
